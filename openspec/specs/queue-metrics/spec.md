...
Defines the requirements for tracking BullMQ queue and job metrics via Prometheus in the worker app. Covers lazy queue-depth gauges per state, per-job-type duration histograms, and failed-job counters.
